 ...
 *
 */
public class MarvelGraphFactoryTest {
    private static final SecureRandom RANDOM = new SecureRandom();
    private static final int BATCH_SIZE = 10;
    private static final Logger LOG = LoggerFactory.getLogger(MarvelGraphFactoryTest.class);
    ...
    private static final String TIMER_LINE = "MarvelGraphFactoryTest.line";
    private static final String TIMER_CREATE = "MarvelGraphFactoryTest.create_";
    private static final String COUNTER_GET = "MarvelGraphFactoryTest.get_";
    ...
    public static void load(final JanusGraph graph, final int rowsToLoad, final boolean report) throws Exception {
        ...
        ClassLoader classLoader = MarvelGraphFactoryTest.class.getClassLoader();
        ...
        LOG.info("MarvelGraphFactoryTest.load complete");
    }
